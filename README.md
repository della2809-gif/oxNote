...
- [Claude API](https://console.anthropic.com) (`claude-sonnet-5`) — 오답 원인 분석
...
| `ANTHROPIC_API_KEY` | [console.anthropic.com](https://console.anthropic.com)에서 발급한 Claude API 키 |
...
- **오답 입력 & AI 분석**: 문제/내 답/정답을 입력하면 Claude가 오답 원인과 학습 포인트를 자동 분석 (`src/app/(app)/notes/actions.ts`)
...
3. Environment Variables에 위 3개 변수(`NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `ANTHROPIC_API_KEY`)를 등록합니다.
